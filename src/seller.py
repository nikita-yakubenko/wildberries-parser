...
class Seller:
	...
	def __create_urls(self) -> None:
		...
		self.__URLS_MAP: dict = {
			'products': f'https://catalog.wb.ru/sellers/catalog?appType=1&curr=rub&dest=-1257786&regions=80,38,83,4,64,33,68,70,30,40,86,75,69,1,31,66,22,110,48,71,114&sort={self.__ordering}&spp=0&supplier={self.__seller_id}',
