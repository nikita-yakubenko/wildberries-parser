...
class Product:
    ...
    def __create_urls(self) -> None:
        ...
        self.__URLS_MAP: dict = {
            ...
            'detail': 'https://card.wb.ru/cards/detail?appType=1&curr=rub&regions='
                     f'80,38,83,4,64,33,68,70,30,40,86,75,69,1,31,66,22,110,48,71,114&spp=0&nm={self.__product_id}',
            'price_history': f'https://{self.__vhost}/vol{self.__vol}/part{self.__part}/{self.__product_id}/'
                              'info/price-history.json',
            'sold_count': f'https://product-order-qnt.wildberries.ru/v2/by-nm/?nm={self.__product_id}',
            'seller': f'https://{self.__vhost}/vol{self.__vol}/part{self.__part}/{self.__product_id}/'
                       'info/sellers.json',
